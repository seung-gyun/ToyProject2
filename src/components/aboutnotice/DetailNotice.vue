<template>
  <div class="form-signin w-100 m-auto">
    ...
    <div class="form-floating">
      ...
      <button v-if="state.memberId == store.state.account.memberId" class="btn btn-primary w-100 py-2" @click.prevent="registerNotice()">Register notice</button>
...
export default {
  ...
  setup(props) {
    ...
    const registerNotice =()=>{
        ...
        axios.patch("/savemoney/updatenotice", { memberId: state.memberId, title: state.title, content: state.content}).then(()=>{
    ...
    return {state, store, registerNotice};
